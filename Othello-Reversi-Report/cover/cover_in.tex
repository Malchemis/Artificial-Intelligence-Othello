...
\noindent\begin{tikzpicture}[remember picture, overlay, shift={(current page.south west)}]
    %Images
    \node[anchor=north west] at (1.35,23.7) {\includegraphics[height=1.6cm, keepaspectratio]{cover/meta/insa-logo.png}};
    \node[anchor=north east] at (19.65,23.8) {\includegraphics[height=1.8cm, keepaspectratio]{cover/meta/uphf-logo.png}};
