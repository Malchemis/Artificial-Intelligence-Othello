...
\label{subsec:shift}
Pour réaliser cela, nous devons être capable de décaler un plateau entier dans les 8 directions cardinales. Nous y parvenons en utilisant les opérations logiques suivantes :
\begin{algorithm}
